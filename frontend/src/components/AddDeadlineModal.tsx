...
const AddDeadlineModal: React.FC<AddDeadlineModalProps> = ({ onClose, onSuccess }) => {
  const [formData, setFormData] = useState({
    title: '',
    description: '',
    deadline_date: '',
    deadline_type: 'application' as Deadline['deadline_type'],
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-gray-900">Add New Deadline</h2>
            <button
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="e.g., Submit NYU Application"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="deadline_type" className="block text-sm font-medium text-gray-700">
                  Type *
                </label>
                <select
                  id="deadline_type"
